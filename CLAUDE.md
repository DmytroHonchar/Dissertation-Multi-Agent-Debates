...
Implemented: `benchmark.py`, `api_client.py`. Everything else in P2–P13 is still
to be written. **Create a module when you write its first real line — do not
scaffold empty files.**

## Commands

```bash
.venv/bin/python -m pytest                 # 29 tests, all passing
