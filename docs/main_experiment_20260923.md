...
JSON record and seven CSV tables. Remaining work is to inspect representative
changed questions, build the read-only replay interface and write the
dissertation and CA2 materials.
